...
class contactsProPluginBackendAutocompleteController extends waJsonController
{
    public function execute()
    {
        ...
        if (waRequest::request('my_created')) {
            $contacts->addWhere("create_contact_id = " . wa()->getUser()->getId());
        }
