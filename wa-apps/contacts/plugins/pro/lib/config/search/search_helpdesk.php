...
return array(
    'name' => 'Helpdesk',                                               // _wp('Helpdesk')
    'items' => array(
        'helpdesk' => array(
            'name' => 'Wrote requests',       // _wp('Wrote requests')
            'join' => array(
            ...
            'items' => array(
                ...
                'status' => array(
                    'name' => 'Current status',   // _wp('Current status')
                    'readonly' => true,
                    'items' => array(
                        ':values' => array(
        ...
        'helpdesk_actions' => array(
            'name' => 'Performed an action with requests',        // _wp('Performed an action with requests')
            'join' => array(
            ...
            'items' => array(
                ...
                'action' => array(
                    ...
                    'items' => array(
                        ':values' => array(
                            'class' => 'contactsSearchHelpdeskActionsValues'
                        )
                    )
                )
            )
